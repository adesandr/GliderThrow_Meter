...
.. note:: Take so take care to build the project with an ESP-IDF framework < v4.1 (tcp_adaptor & event_loop API have changed).
...
==================  ================== 
|Get Started|_      |Software Design|_ 
------------------  ------------------
`Get Started`_      `Software Design`_ 
==================  ==================
==================  ==================
|Hardware Design|_  |System Build|_
------------------  ------------------
`Hardware Design`_  `System Build`_
==================  ==================
